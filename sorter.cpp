...
{
    // These loops tries to push the largest integers to the left
...
{
    /**
     * @brief A variable that will store the minimum value of the elements in each iteration.
     */
    uint64_t min_value;
...
{
    /**
     * @brief A variable that will store the value of the pivot element.
     */
    int64_t pivot;
...
{
    /**
     * @brief A variable that will store the index of the first element.
     */
    uint64_t first_index;

    /**
     * @brief A variable that will store the index of the last element.
     */
    uint64_t last_index;

    first_index = 0;
    last_index = size(quick_vector) - 1;
...
void sorter::insertion_sort()
{
    ...
    {
        /**
         * @brief Current element in the loop.
         */
...
{
    /**
     * @brief A variable that will store the length of the user vector.
     */
    uint64_t v_length = v.size();

    if (v_length < 2) // means the vector has one element, stop as its sorted and return to function
        return;

    /**
     * @brief A variable to store the middle index
     */
    uint64_t i_mid = v_length / 2;

    /**
     * @brief A vector to store elements in the left half of the split.
     */
    vector<int64_t> left_half;
    /**
     * @brief A vector to store elements in the right half of the split
     */
...
{
    /**
     * @brief A variable to store the length of the left half vector.
     */
    uint64_t left_length = left_half.size();
    /**
     * @brief A variable to store the length of the right half vector.
     */
    uint64_t right_length = right_half.size();
    ...
    // The below code checks and iterate through the indicies of the the two vectors
    // As well as sort them and build the new larger vector
...
{
    /**
     * @brief A variable to store the size of the user vector.
     */
    uint64_t n = v.size();
...
{
    /**
     * @brief A variable to assign and store largest variable as root node (assumption) index.
     */
    uint64_t largest = i;
    /**
     * @brief A variable to store the left child of the subtree index.
     */
    uint64_t left_child = 2 * i + 1;
    /**
     * @brief A variable to store the right child of the subtree index.
     */
